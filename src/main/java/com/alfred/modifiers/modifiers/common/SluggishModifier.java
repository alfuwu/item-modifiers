...
public class SluggishModifier extends ItemModifier {
    public SluggishModifier() {
        super("Sluggish", ModifierType.COMMON);
    }
    ...
    public void applyModifier(ItemStack itemStack) {
        ...
        Util.modifyStack(itemStack, null, null, null, 0.8f);
    }
}
