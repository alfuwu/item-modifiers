...
public class PowerfulModifier extends ItemModifier {
    public PowerfulModifier() {
        super("Powerful", ModifierType.RANGED);
    }
    ...
    public void applyModifier(ItemStack itemStack) {
        ...
        Util.modifyStack(itemStack, 1.5f, null, null, 0.9f);
        itemStack.getOrCreateNbt().putDouble(Constants.CRIT, 0.01);
    }
}
