...
public class DangerousModifier extends ItemModifier {
    public DangerousModifier() {
        super("Dangerous", ModifierType.MELEE_TOOL);
    }
    ...
    public void applyModifier(ItemStack itemStack) {
        ...
        itemStack.getOrCreateNbt().putDouble(Constants.SIZE, 1.05);
