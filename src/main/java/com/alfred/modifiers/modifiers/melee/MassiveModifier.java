...
public class MassiveModifier extends ItemModifier {
    public MassiveModifier() {
        super("Massive", ModifierType.MELEE_TOOL);
    }
    ...
    public void applyModifier(ItemStack itemStack) {
        ...
        itemStack.getOrCreateNbt().putDouble(Constants.KNOCKBACK, 1.18);
        itemStack.getOrCreateNbt().putDouble(Constants.SIZE, 1.18);
    }
}
