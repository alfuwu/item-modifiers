...
public class TinyModifier extends ItemModifier {
    public TinyModifier() {
        super("Tiny", ModifierType.MELEE_TOOL);
    }
    ...
    public void applyModifier(ItemStack itemStack) {
        ...
        itemStack.getOrCreateNbt().putDouble(Constants.KNOCKBACK, 0.82);
        itemStack.getOrCreateNbt().putDouble(Constants.SIZE, 0.82);
    }
}
